...
const NumberComponent = function (props) {
    ...
    return (react_1.default.createElement(native_base_1.FormControl, { isInvalid: isError, isRequired: required },
        ...
        react_1.default.createElement(native_base_1.Input, Object.assign({}, inputProps)),
...
exports.default = (0, withRuleEngine_1.default)(NumberComponent);
