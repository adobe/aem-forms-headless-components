...
const RadioGroupComponent = function (props) {
    const { isError, required, label, errorMessage, description, value, enumNames, name, dispatchChange } = props;
    ...
    return (react_1.default.createElement(native_base_1.FormControl, { isInvalid: isError, isRequired: required },
        ...
        react_1.default.createElement(native_base_1.Radio.Group, { onChange: changeHandler, value: value, name: name || 'radio' }, options === null || options === void 0 ? void 0 : options.map((text, index) => (react_1.default.createElement(native_base_1.Radio, { key: enums[index], value: enums[index], style: { marginTop: 3 } }, text)))),
...
exports.default = (0, withRuleEngine_1.default)(RadioGroupComponent);
