...
const CheckboxGroupComponent = function (props) {
    const { isError, required, label, errorMessage, description, value, type, enumNames, dispatchChange } = props;
    ...
    const changeHandler = (0, react_1.useCallback)((val) => {
        ...
        if (isArray) {
            ...
            finalVal = val.filter((x) => value !== x)[0];
        }
        else {
            finalVal = null;
        }
    ...
    return (react_1.default.createElement(native_base_1.FormControl, { isInvalid: isError, isRequired: required },
        ...
        react_1.default.createElement(native_base_1.Checkbox.Group, { onChange: changeHandler }, options === null || options === void 0 ? void 0 : options.map((text, index) => (react_1.default.createElement(native_base_1.Checkbox, { key: enums[index], value: enums[index] }, text)))),
...
exports.default = (0, withRuleEngine_1.default)(CheckboxGroupComponent);
