  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-cmp-visible={visible}
        style={
          props?.properties?.isPopUp ? { display: open ? 'block' : 'none' } : {}
        }
      >
          ...
          <div className="cmp-adaptiveform-termsandcondition__content">
            {visibleItems
              ...
              .map((item: PROPS, index: number) => (
                ...
                >
                  <div>{getChild(item, index)}</div>
                  <div className="cmp-adaptiveform-termsandcondition__text-intersect"></div>
                </div>
              ))}
          </div>
        </div>
