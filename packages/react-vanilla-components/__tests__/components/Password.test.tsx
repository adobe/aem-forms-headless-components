...
describe("Password Field", () => {
  ...
  test("the widget renders as a password input", async () => {
  ...
  test('In case of both tooltip and description, tooltip should be visible and onclick of toggle button, description should be visible', async () => {
    ...
    const button = renderResponse.container.getElementsByClassName('cmp-adaptiveform-passwordinput__questionmark');
